package com.antz.teavm.mundus.runtime.example;
...
public class MundusExample extends ApplicationAdapter {
    ...
    public void create () {
        ...
        // These two lines are new for TeaVM support - you must rename assets.txt and assets folder
        Mundus.PROJECT_ASSETS_DIR = "files";
        AssetManager.MUNDUS_ASSET_FILE = "mundus_assets.txt";
